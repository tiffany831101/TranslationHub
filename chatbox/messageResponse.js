...
module.exports = {
  ...
  Features: function (client, event) {
    return client.replyMessage(event.replyToken, response.skills);
  },
  English: function (client, event) {
    return client.replyMessage(event.replyToken, response.skills);
  },
  "Start Translating": function (client, event) {
    return client.replyMessage(event.replyToken, response.chat);
  },
  Chat: function (client, event) {
    return client.replyMessage(event.replyToken, response.chat);
  },
};
